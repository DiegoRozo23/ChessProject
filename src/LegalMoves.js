...
export default function LegalMoves() {
  ...
  function onSquareClick(square) {
    ...
    if (selectedSquare) {
      if (makeAMove({ from: selectedSquare, to: square })) setSelectedSquare(null)
  ...
  return <div className="Main">
          <div className="chess-app"> 
            <Chessboard position={game.fen()} onPieceDrop={onDrop} onSquareClick={onSquareClick} customSquareStyles={customSquareStyles} onSquareRightClick={rightClick} customDarkSquareStyle={{ backgroundColor: '#6c809a' }}
